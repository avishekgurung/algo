...
public class Problem058 {
   ...
   *
   * Approach 2. Find in-order and pre-order traversal of T and store them in an array, iT[], pT[]. Find in-order and pre-order traversal of S and store them in arrays iS[], pS[].
